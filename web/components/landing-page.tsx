...
import { ActiveWars } from "@/components/active-wars"
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
        ...
        <main className="grid md:grid-cols-2 gap-8 mt-12">
          ...
          >
            ...
            >
              A BLOCKCHAIN-BASED SOCIAL STRATEGY GAME WHERE CLANS BATTLE USING REAL ONCHAIN SOCIAL DATA. YOUR INFLUENCE,
              ENGAGEMENT, AND EARNINGS ARE YOUR WEAPONS.
            </p>
            ...
            <div className="relative h-[400px] w-full overflow-hidden rounded-lg border border-[#1F1F2A] shadow-[0_0_25px_rgba(57,255,20,0.2)]">
              ...
              <div className="absolute bottom-0 left-0 right-0 p-6 z-20">
                <div className="flex items-center justify-between">
                  <div>
                    <h3 className="text-[#FAFAFA] font-bold text-xl">SEASON 1 ACTIVE</h3>

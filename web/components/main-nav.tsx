                    ...
                    <div className="w-10 h-10 shadow-[#39FF14] shadow-lg bg-gray-700 overflow-hidden rounded-full border-2 border-[#39FF14] flex items-center justify-center">
                      {profile.metadata?.picture ? (
                        <Avatar>
                          ...
                          />
                          <AvatarFallback>
                            {profile.metadata?.name?.[0] || profile.username?.localName?.[0] || "👤"}
                          </AvatarFallback>
                        </Avatar>
                      ) : (
                        <Avatar>
                  ...
                  <DropdownMenuLabel>
                    <div className="flex flex-col items-start">
                      <span className="font-bold text-white text-base">
                        {profile.metadata?.name || profile.username?.localName || "Anonymous"}
                      </span>

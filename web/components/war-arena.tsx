...
export default function WarArena() {
  ...
  // Mock data for upcoming wars
  const upcomingWars = [
    {
      id: "upcoming-1",
      clan1: { id: "clan-7", name: "TOKEN TITANS", logo: "/placeholder.svg?height=100&width=100" },
      clan2: { id: "clan-8", name: "NFT NINJAS", logo: "/placeholder.svg?height=100&width=100" },
    ...
    },
    {
      id: "upcoming-2",
      clan1: { id: "clan-1", name: "CYBER WOLVES", logo: "/placeholder.svg?height=100&width=100" },
      clan2: { id: "clan-5", name: "META MARINES", logo: "/placeholder.svg?height=100&width=100" },
    ...
    <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
      ...
      <Tabs defaultValue="active" className="w-full">
        <TabsList className="bg-black border border-[#a3ff12] p-1 w-full grid grid-cols-3">
          <TabsTrigger value="active" className="data-[state=active]:bg-[#a3ff12] data-[state=active]:text-black">
            ACTIVE WARS
          </TabsTrigger>
          <TabsTrigger value="upcoming" className="data-[state=active]:bg-[#a3ff12] data-[state=active]:text-black">
            UPCOMING WARS
          </TabsTrigger>
          <TabsTrigger value="completed" className="data-[state=active]:bg-[#a3ff12] data-[state=active]:text-black">
            COMPLETED WARS
          </TabsTrigger>
        </TabsList>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
            {upcomingWars.map((war) => (
              ...
              >
                <div className="p-6">
                  <div className="flex justify-between items-center mb-4">
                    <h3 className="text-white font-bold text-lg">UPCOMING WAR</h3>
                    <div className="px-3 py-1 bg-gray-800 text-white text-xs font-bold rounded-full flex items-center">
                      <Clock className="h-3 w-3 mr-1" />
                      STARTS IN {war.startsIn}
                    </div>
                  </div>
